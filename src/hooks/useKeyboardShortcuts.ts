...
export function useKeyboardShortcuts(
  ...
  }, [shortcuts, evaluateWhenCondition, activeSubContext]);
  ...
  const handleKeyDown = useCallback(
    (event: KeyboardEvent) => {
      ...
      if (prefixActiveRef.current) {
        ...
        const prefixShortcuts = categorizedShortcuts.prefixGroups[currentPrefix];
    ...
    [categorizedShortcuts, handlers, matchesKeyCombo, isOptionPressed, ignoreInputFields],
  );
